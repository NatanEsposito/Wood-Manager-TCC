	...
	<div class="container py-4">
		<div class="p-5 mb-4 bg-body-tertiary rounded-3 text-center shadow">
			<div class="container-fluid py-1">
				<h1 class="display-6 fw-bold">Sobra de Material</h1>
				...
				<form action=sobramaterial method="post" class="row g-3 mt-3"
						...
						<div class="col-md-4">
							<div class="form-floating">
								<input class="form-control" type="number" min="0" step="1"
									...
									value='<c:out value="${sobramaterial.codigo}"></c:out>'>
						...
						<div class="col-md-3">
							<div class="form-floating">
								<input class="form-control" type="text" id="estoque"
									name="estoque" placeholder="Nome" maxlength="100"
						...
						<div class="col-md-4">
							<div class="form-floating">
								<input type="date" id="data" name="data" class="form-control"
									...
									value='<c:out value="${sobramaterial.data}"></c:out>'>
					...
					<thead>
						<tr>
							<th class="titulo-tabela" colspan="9"
								style="text-align: center; font-size: 35px;">Lista de Sobra
								de Materiais</th>
						</tr>
						<tr class="table-dark">
							<th></th>
							...
							<tr>
								<td style="text-align: center;">
									<button class="btn btn-outline-dark" name="opcao"
										value="${sm.codigo}" onclick="editarSobraMaterial(this.value)"
										${sm.codigo eq codigoEdicao ? 'checked' : ''}>
						...
						<path fill-rule="evenodd"
								...
								<td style="text-align: center;">
									<button class="btn btn-danger"
										onclick="excluirSobraMaterial('${sm.codigo}')">Excluir</button>
								</td>
						</c:forEach>
					</tbody>
				</table>
