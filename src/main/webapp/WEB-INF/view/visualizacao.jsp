...
<script
	src="${pageContext.request.contextPath}/resources/js/SobraMaterial.js"></script>
		...
		<div class="p-5 mb-4 bg-body-tertiary rounded-3 text-center shadow">
			...
			<form action="visualizacao" method="post" class="row g-3 mt-3">
				...
				<div class="row g-3">
					...
					<div class="col-md-6">
						<div class="form-floating">
							...
							</select> <label for="material">Material</label>
						</div>
					</div>
				...
				<div class="row g-3 mt-3">
					...
					<!-- Limpar -->
					<div class="col-md-6 d-grid">
						<button type="submit" id="botao" name="botao" value="Limpar"
							class="btn btn-secondary btn-align" style="height: 56px;">
							Limpar</button>
					</div>

				</div>
				
				<!-- QUARTA LINHA: Nicho | Prateleira | Porta Copo -->
				<div class="col-md-4 d-grid">
					<a href="${pageContext.request.contextPath}/visualizacao/nicho"
						class="btn btn-outline-dark w-100"> <i class="bi bi-box me-2"></i>
						Nicho
					</a>
				</div>
				...
				<div class="col-md-4 d-grid">
					<a
						href="${pageContext.request.contextPath}/visualizacao/prateleira"
						class="btn btn-outline-dark w-100"> <i
						class="bi bi-columns-gap me-2"></i> Prateleira
					</a>
				</div>

				<div class="col-md-4 d-grid">
					<a
						href="${pageContext.request.contextPath}/visualizacao/portacopos"
						class="btn btn-outline-dark w-100"> <i class="bi bi-disc me-2"></i>
						Porta Copo
					</a>
				</div>
			</form>
